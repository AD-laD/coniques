...
void draw::conic_tangents(Viewer_conic &viewer){
    ...
    Droite d1(1.0,2.0,3.0),d2(-1.0,-1.0,5.0),d3(0.0,2.5,3.0),d4(-4.0,-5.0,0.0),d5(2.0,3.0,4.0);
    ...
    // Droite d_ex1(1.0,1.0,1.0);
    // Droite d_ex2(0.0,1.0,0.0); // deux droites non parallèles
